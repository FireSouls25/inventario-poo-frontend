...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, RouterLink, MatCardModule, MatFormFieldModule, MatInputModule, MatSelectModule, MatButtonModule, MatProgressSpinnerModule, MatIconModule, NgIf],
  template: `
    <div style="display:flex; justify-content:center; align-items:center; min-height:100vh; background:linear-gradient(135deg, #f4f2ef 0%, #e8e2da 100%);">
      <mat-card style="width:400px; padding:32px; text-align:center;">
        <mat-icon style="font-size:48px;width:48px;height:48px;color:#e65100;margin-bottom:8px;">person_add</mat-icon>
        <h2 style="margin:0 0 24px;font-weight:400;color:#3e3a36;">Crear Cuenta</h2>
        ...
        <div style="margin-top:20px;">
          <a mat-button routerLink="/auth/login" style="color:#e65100;">Ya tengo cuenta</a>
        </div>
      </mat-card>
    </div>
  `
